...
values ('s1@jmu.edu','c1'),
		...
		('s3@jmu.edu','c3')
--q2.5
-- Professor first, because the course requires the professor to be submitted first.
insert into professor (p_email,p_name,office)
...
--update the course table first, then the professor table, otherwise p1 will still be in the system
